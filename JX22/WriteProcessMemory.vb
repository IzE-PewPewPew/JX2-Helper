...
Module Trainer
    ...
    Public Function ReadPointerDouble(ByVal ID As Integer, ByVal Pointer As Integer, ByVal ParamArray Offset As Integer()) As Double
        Dim num2 As Double
        If (Process.GetProcessById(ID).ToString.Length > 0) Then
            ...
            Next
            num6 = 0
            ReadMemoryDouble(handle, Pointer, num2, 8, num6)
        End If
        Return num2
    End Function
